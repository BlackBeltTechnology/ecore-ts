...
describe('Ecore', function () {
  ...
  describe('#EClass', function () {
    ...
    it('should contain EClass references', function () {
      var eClass = Ecore.EClass;
      // eStructuralFeatures
      var eStructuralFeatures = Ecore.EClass.getEStructuralFeature(
        'eStructuralFeatures',
      );
  ...
  describe('#EStructuralFeature', function () {
    ...
    it('should contain EStructuralFeature attributes', function () {
      // changeable
      var changeable =
        Ecore.EStructuralFeature.getEStructuralFeature('changeable');
      assert.ok(changeable);
      assert.strictEqual(changeable.eClass, Ecore.EAttribute);

      // volatile
      var _volatile =
        Ecore.EStructuralFeature.getEStructuralFeature('volatile');
      assert.ok(_volatile);
      assert.strictEqual(_volatile.eClass, Ecore.EAttribute);

      // transient
      var _transient =
        Ecore.EStructuralFeature.getEStructuralFeature('transient');
      assert.ok(_transient);
      assert.strictEqual(_transient.eClass, Ecore.EAttribute);

      // defaultValueLiteral
      var defaultValueLiteral = Ecore.EStructuralFeature.getEStructuralFeature(
        'defaultValueLiteral',
      );
      ...
      // defaultValue
      var defaultValue =
        Ecore.EStructuralFeature.getEStructuralFeature('defaultValue');
      assert.ok(defaultValue);
      assert.strictEqual(defaultValue.eClass, Ecore.EAttribute);

      // unsettable
      var unsettable =
        Ecore.EStructuralFeature.getEStructuralFeature('unsettable');
  ...
  describe('#EReference', function () {
    ...
    it('should contain EReference attributes', function () {
      ...
      // resolveProxies
      var resolveProxies =
        Ecore.EReference.getEStructuralFeature('resolveProxies');
  ...
  describe('#EOperation', function () {
    ...
    it('should contain EOperation references', function () {
      ...
      var eTypeParameters =
        Ecore.EOperation.getEStructuralFeature('eTypeParameters');
      ...
      var eGenericExceptions =
        Ecore.EOperation.getEStructuralFeature('eGenericExceptions');
  ...
  describe('#EClass', function () {
    ...
    it('should have correct references', function () {
      ...
      var eStructuralFeatures = EClass.getEStructuralFeature(
        'eStructuralFeatures',
      );
  ...
  describe('ETypeParameter', function () {
    ...
    it('should have correct attributes', function () {
      ...
      assert.ok(
        ETypeParameter.get('eSuperTypes').contains(Ecore.ENamedElement),
      );
    });
